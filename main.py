...
pantalla = Entry(root, width=22, bg="black", fg="white", borderwidth=0, font=("arial", 18, "bold"), justify= "right", textvariable=numeroPantalla)
pantalla.grid(row=0, column=0, columnspan=4, padx=1, pady=1, sticky="ew") #Puse 4 y 1
